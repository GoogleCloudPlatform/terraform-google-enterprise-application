...
| create\_artifact\_registry\_remote\_dockerhub | Create a Artifact Registry repository remote to dockerhub. | `bool` | `false` | no |
| create\_artifact\_registry\_remote\_python | Create a Artifact Registry repository remote to PYPI. | `bool` | `false` | no |
...
| network\_id | The network self link to be used by private worker pool. | `string` | n/a | yes |
