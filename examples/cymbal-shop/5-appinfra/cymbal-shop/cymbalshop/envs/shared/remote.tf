...
locals {
  ...
  cluster_projects_number = { for state in data.terraform_remote_state.multitenant : (state.outputs.env) => { "cluster_project_number" = (state.outputs.cluster_project_number) } }
