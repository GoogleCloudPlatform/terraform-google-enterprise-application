...
| <a name="input_workerpool_machine_type"></a> [workerpool\_machine\_type](#input\_workerpool\_machine\_type) | The workerpool machine type. | `string` | n/a | yes |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_attestation_evaluation_mode"></a> [attestation\_evaluation\_mode](#output\_attestation\_evaluation\_mode) | The attestation evaluation mode, which is set to 'REQUIRE\_ATTESTATION' if there is only one environment, and 'ALWAYS\_ALLOW' otherwise. |
| <a name="output_attestation_kms_key"></a> [attestation\_kms\_key](#output\_attestation\_kms\_key) | The KMS key for attestation. |
| <a name="output_billing_account"></a> [billing\_account](#output\_billing\_account) | The billing account ID. |
| <a name="output_bucket_kms_key"></a> [bucket\_kms\_key](#output\_bucket\_kms\_key) | The KMS key for the bucket. |
| <a name="output_common_folder_id"></a> [common\_folder\_id](#output\_common\_folder\_id) | The ID of the common folder. |
| <a name="output_envs"></a> [envs](#output\_envs) | A map of environments to their respective VPC information. |
| <a name="output_logging_bucket"></a> [logging\_bucket](#output\_logging\_bucket) | The name of the logging bucket. |
| <a name="output_org_id"></a> [org\_id](#output\_org\_id) | The organization ID. |
| <a name="output_project_id"></a> [project\_id](#output\_project\_id) | The ID of the seed project. |
| <a name="output_workerpool_id"></a> [workerpool\_id](#output\_workerpool\_id) | The ID of the private worker pool. |
