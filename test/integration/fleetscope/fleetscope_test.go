	...
	for _, envName := range testutils.EnvNames(t) {
		...
		t.Run(envName, func(t *testing.T) {
			...
			fleetscope.DefineVerify(func(assert *assert.Assertions) {
				...
				t.Logf("rendering.errorSummary: %v", jsonOutput.Get("rendering.errorSummary").String())
				t.Logf("source.errorSummary: %v", jsonOutput.Get("source.errorSummary").String())
				t.Logf("sync.errorSummary: %v", jsonOutput.Get("sync.errorSummary").String())
