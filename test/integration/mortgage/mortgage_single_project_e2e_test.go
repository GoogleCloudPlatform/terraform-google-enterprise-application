...
func TestMortgageSingleProjectE2E(t *testing.T) {
	...
	for _, envName := range testutils.EnvNames(t) {
		...
		t.Run(envName, func(t *testing.T) {
			...
			infraSingleProject := tft.NewTFBlueprintTest(t, tft.WithTFDir("../../../examples/mortgage/standalone-single-project"))
			...
			namespace := fmt.Sprintf("mortgage-%s", envName)
