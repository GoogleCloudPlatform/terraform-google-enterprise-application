...
func TestAppSourceLedgerwriter(t *testing.T) {
	...
	projectID := appFactory.GetJsonOutput("app-group").Get("ledgerwriter.app_admin_project_id").String()
	...
	frontend := tft.NewTFBlueprintTest(t,
		tft.WithTFDir("../../../5-appinfra/apps/ledger-ledgerwriter/envs/shared"),
		tft.WithVars(vars),
