...
You will need a Google Cloud project with [KMS](https://cloud.google.com/kms/docs/key-management-service).
...
The module creates a Private Worker Pool in his own project, a peered VPC with a NAT VM who allows internet egrees to get external dependencies.
...
You will need a pre created folders:
