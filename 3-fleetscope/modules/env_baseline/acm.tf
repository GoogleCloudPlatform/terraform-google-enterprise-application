...
resource "google_project_iam_binding" "acm_wi_trace_agent" {
  ...
  members = [
    ...
    "principal://iam.googleapis.com/projects/${data.google_project.cluster_project.number}/locations/global/workloadIdentityPools/${var.fleet_project_id}.svc.id.goog/subject/ns/accounts-${var.env}/sa/cymbal-bank",
    "principal://iam.googleapis.com/projects/${data.google_project.cluster_project.number}/locations/global/workloadIdentityPools/${var.fleet_project_id}.svc.id.goog/subject/ns/ledger-${var.env}/sa/cymbal-bank",
    "principal://iam.googleapis.com/projects/${data.google_project.cluster_project.number}/locations/global/workloadIdentityPools/${var.fleet_project_id}.svc.id.goog/subject/ns/frontend-${var.env}/sa/cymbal-bank",
